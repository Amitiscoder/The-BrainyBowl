...
const testimonials = [
    {
        ...
        avatar:
            'https://avatars.githubusercontent.com/u/81972492?v=4',
    }
];
    ...
    return (
        <Flex
            ...
            <Flex
                ...
                <chakra.p fontFamily={'Work Sans'} color={'pink.600'} fontWeight={'bold'} fontSize={16}>
                    {name}
                    <chakra.span
                        fontFamily={'Inter'}
                        fontWeight={'bold'}
        ...
        <Flex
            ...
            <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                ...
                <chakra.h2
                    ...
                    fontFamily={'Inter'}
                    fontWeight={'medium'}
                    color={useColorModeValue('pink.200', 'pink.200')}>
            ...
            <Box>
                <Icon viewBox="0 0 40 35" mt={14} boxSize={10} color={'red.700'}>
                    <path
                        fill={'currentColor'}
